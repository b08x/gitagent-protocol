...
import { runWithMistralVibe } from '../runners/mistral-vibe.js';
...
export const runCommand = new Command('run')
  ...
  .option('-a, --adapter <name>', 'Adapter: claude, openai, crewai, openclaw, nanobot, lyzr, github, opencode, gemini, gitclaw, mistral-vibe, git, prompt', 'claude')
    ...
    try {
      switch (options.adapter) {
        ...
        default:
          ...
          info('Supported adapters: claude, openai, crewai, openclaw, nanobot, lyzr, github, opencode, gemini, gitclaw, mistral-vibe, git, prompt');
          process.exit(1);
      }
    } catch (e) {
