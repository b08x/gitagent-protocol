...
export const exportCommand = new Command('export')
  ...
  .requiredOption('-f, --format <format>', 'Export format (system-prompt, claude-code, openai, crewai, openclaw, nanobot, lyzr, github, copilot, opencode, cursor, gemini, codex, kiro, gitclaw, mistral-vibe)')
    ...
    try {
      ...
      switch (options.format) {
        ...
        case 'gitclaw':
          ...
          break;
        case 'mistral-vibe':
          result = exportToMistralVibeString(dir);
          break;
        default:
          error(`Unknown format: ${options.format}`);
          info('Supported formats: system-prompt, claude-code, openai, crewai, openclaw, nanobot, lyzr, github, copilot, opencode, cursor, gemini, codex, kiro, gitclaw, mistral-vibe');
          process.exit(1);
      }
